...
#         print('Folder {model_dir} does not exist')
    ...
    model.build_model()
    model.train(15000, generate_input_fn)
    log.setLevel('ERROR')
...
for i in range(3):
    ...
    vanilla = make_model('model_out2/vanilla', False, False, 'ATTACHED', gs, ax1)
    encoder = make_model('model_out2/encoder_attached', False, True, 'ATTACHED', gs, ax2)
    encoder_i = make_model('model_out2/encoder_indep', False, True, 'INDEPENDENT', gs, ax3)
    reconstruct = make_model('model_out2/reconstruction_attached', True, True, 'ATTACHED', gs, ax4)
    reconstruct_i = make_model('model_out2/reconstruction_indep', True, True, 'INDEPENDENT', gs, ax5)
