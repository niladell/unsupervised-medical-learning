...
def discriminator(x,  dataset, is_training=True, scope='Discriminator', noise_dim=None):
    with tf.variable_scope(scope, reuse=tf.AUTO_REUSE):
        tf.logging.debug('Discriminator %s', dataset)
...
def generator(x, dataset, is_training=True, scope='Generator'):
    with tf.variable_scope(scope, reuse=tf.AUTO_REUSE):
        tf.logging.debug('Generator %s', dataset)
